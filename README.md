...
### What I work on
- AI Applications & Agents: Multi-agent systems, browser automation, MCP implementations
- Production Systems: Document processing, fraud detection, order automation
- Developer Tools: Native applications, CLI tools, development workflows
- RAG Architectures: Agentic RAG, hybrid search, multi-tenant patterns
